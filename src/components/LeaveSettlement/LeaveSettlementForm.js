import { Grid,Card,
  ...
  import {inputLeaveSettlementForm} from './LeaveSettlement';
  ...
  export default function LeaveSettleForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Leave Settlement</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputLeaveSettlementForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
