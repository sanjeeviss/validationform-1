import { Grid,Card,
  ...
  import {inputpaymJobStatusForm} from './paymJobStatus';
  ...
  export default function JobStatusForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Job Status</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputpaymJobStatusForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
