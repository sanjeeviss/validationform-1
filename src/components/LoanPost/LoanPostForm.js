import { Grid,Card,
  ...
  import {inputLoanPostForm} from './LoanPost';
  ...
  export default function LoanPostForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Loan Post</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputLoanPostForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
