import { Grid,Card,
  ...
  import {inputondutyForm} from './onduty';
  ...
  export default function OndutyForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">OnDuty</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputondutyForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
