import { Grid,Card,
  ...
  import {inputLoanPrecloserForm} from './LoanPrecloser';
  ...
  export default function LoanPreclosForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Loan Preclosure</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputLoanPrecloserForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
