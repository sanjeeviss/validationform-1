  ...
  export default function DesignationForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Designation</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputpaymDesignationForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
