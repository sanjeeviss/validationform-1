import { Grid,Card,
  ...
  export default function SkillsMasterForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Hrmm Skills Master</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
             inputFormHrmmSkillsMaster.map(input=> <Grid xs={input.xs} sm={input.sm} item>
