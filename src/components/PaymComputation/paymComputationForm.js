import { Grid,Card,
  ...
  import {inputpaymComputationForm} from './paymComputation';
  ...
  export default function ComputationForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Computation</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputpaymComputationForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
