import { Grid,Card,
  ...
  import {inputPaymAttBonusForm} from './PaymAttbonus';
  ...
  export default function PaymattbonusForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Att Bonus</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputPaymAttBonusForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
