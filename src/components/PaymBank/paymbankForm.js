import { Grid,Card,
  ...
  import {inputpaymbankForm} from './paymbank';
  ...
  export default function PaybankForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Bank</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
          inputpaymbankForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
