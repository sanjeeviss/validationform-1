import { Grid,Card,
  ...
  import {inputPayInputForm} from './PayInput';
  ...
  export default function PayinputForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Pay Input</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
          inputPayInputForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
