  ...
  export default function SpecializationForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Hrmm Specialization</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
             inputFormHrmmSpecialization.map(input=> <Grid xs={input.xs} sm={input.sm} item>
