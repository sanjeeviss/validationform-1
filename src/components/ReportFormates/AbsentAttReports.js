  ...
  return (
    <div style={{ textAlign: 'center', margin: '20px' }}>
      ...
      <Grid>
        ...
        Absent Details For the Period of 01/10/2010 to 30/10/2010      
          </Typography>
      </Grid>
      <Grid>
          ...
          <Table>
            <TableBody>
              <TableRow sx={{ borderBottom: '3px solid black',borderTop:'3px solid black', fontWeight: 'bold' }}>
                ...
                <TableCell style={{borderRight:'3px solid black', borderBottom:'3px solid black',fontWeight: 'bold' ,fontSize:20}}>Absent</TableCell>
              ...
              {[...Array(16).keys()].map((row, index) => (
                <TableRow key={row + 1} sx={index === 15 ? { borderBottom: '3px solid black' } : {}}>
                  <TableCell sx={{borderLeft:'2px solid black', borderBottom: '2px solid black',fontWeight: 'bold',fontSize:17}}>{row + 1}</TableCell>
                  <TableCell sx={{ borderBottom: '2px solid black',fontWeight: 'bold',fontSize:17}}>04/10/2010</TableCell>
                  <TableCell  sx={{ borderBottom: '2px solid black',fontWeight: 'bold',fontSize:17 }}>G</TableCell>
                  <TableCell  sx={{borderRight:'2px solid black', borderBottom: '2px solid black',fontWeight: 'bold' ,fontSize:17}}>Absent</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
