  ...
  return (
    <div style={{ textAlign: 'center', margin: '20px' }}>
      ...
      <Grid>
        ...
        LateOut Details For the Period of 01/10/2010 to 30/10/2010      
        </Typography>
      </Grid>
      <Grid>
          ...
          <Table>
            <TableBody>
              <TableRow sx={{ borderBottom: '3px solid black',borderTop:'3px solid black', fontWeight: 'bold' }}>
                ...
                <TableCell style={{borderRight:'3px solid black', borderBottom:'3px solid black',fontWeight: 'bold' ,fontSize:20}}>Late Out</TableCell>
