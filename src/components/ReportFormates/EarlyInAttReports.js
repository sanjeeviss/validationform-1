  ...
  return (
    <div style={{ textAlign: 'center', margin: '20px' }}>
      ...
      <Grid>
        ...
        EarlyIn Details For the Period of 01/10/2010 to 30/10/2010        
        </Typography>
      </Grid>
      <Grid>
          ...
          <Table>
            <TableBody>
              <TableRow sx={{ borderBottom: '3px solid black',borderTop:'3px solid black', fontWeight: 'bold' }}>
                ...
                <TableCell style={{borderRight:'3px solid black', borderBottom:'3px solid black',fontWeight: 'bold' ,fontSize:20}}>Early In</TableCell>
               
              </TableRow>
           
              <TableRow sx={{ borderBottom: '3px solid black', fontWeight: 'bold',bottomLeft:'3px solid black' }}>
                <TableCell style={{borderLeft:'3px solid black',borderBottom: '3px solid black',fontWeight: 'bold',fontSize:18}}>Emp.Code:   001</TableCell>
              ...
              {[...Array(10).keys()].map((row, index) => (
                <TableRow key={row + 1} sx={index === 15 ? { borderBottom: '3px solid black' } : {}}>
                  ...
                  <TableCell  sx={{borderRight:'2px solid black', borderBottom: '2px solid black',fontWeight: 'bold' ,fontSize:16}}>00:04</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
