import { Grid,Card,
  ...
  import {inputpaymCarryForwardForm} from './paymCarryForward';
  ...
  export default function PaymCarrForwardForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Carry Forward</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
             inputpaymCarryForwardForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
