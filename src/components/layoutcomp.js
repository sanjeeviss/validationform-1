...
function Layoutcomp() {
  ...
  const cardsData = [
    ...
    {title: 'Paym Earning', icon: <img src={PaymEarn}  width={40} height={40}/>, onClick: () => navigate("/PaymEarningsTable")},
    {title: 'Paym Emp Deduction', icon: <img src={PaymEmpEarn}  width={40} height={40}/>, onClick: () => navigate("/PaymEmpDeductionTable")},
    {title: 'Paym Emp Earning', icon: <img src={PaymEmpDeduc}  width={40} height={40}/>, onClick: () => navigate("/PaymEmployeeLeaveTable")},
    {title: 'Paym Employee', icon: <img src={PaymEmplo}  width={40} height={40}/>, onClick: () => navigate("/PaymEmpTable")},
    {title: 'Paym Emp Leave', icon: <img src={PaymEmpLeave}  width={40} height={40}/>, onClick: () => navigate("/PaymEmployeeLeaveTable")},
