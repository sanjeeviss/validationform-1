...
console.log(formData)
  ...
  return (
    <div>
      ...
      <CardContent>
      <Typography variant='h5' color='S- Light' align='center'>Leave Approve hr Form</Typography>
      <form>
...
console.log(formData)
postRequest(ServerConfig.url,LEAVEAPPROVEHR,formData).then((e)=>{
console.log(e)
navigate('/LeaveApproveHrTable')
