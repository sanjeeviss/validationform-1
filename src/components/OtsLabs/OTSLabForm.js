import { Grid,Card,
  ...
  import {inputOTSLabForm} from './OTSLab';
  ...
  export default function OTSlabForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">OTS LAB</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
           inputOTSLabForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
