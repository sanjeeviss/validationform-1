...
const PlusIcon = createSvgIcon(
 ...
 function PaymBranchTable(props) {
   const [data,setData]=useState([])
    const navigate = useNavigate();
    useEffect(()=>{

      var data={"controller":PAYMBRANCHES}     
      ...
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">BranchCode</StyledTableCell>
            <StyledTableCell align="center">BranchName</StyledTableCell>
            <StyledTableCell align="center">AddressLine1</StyledTableCell>
            <StyledTableCell align="center">AddressLine2</StyledTableCell>
            ...
            
              {
                data.map((e)=> {
                  ...
                  return<StyledTableRow>
                   ...
                   <StyledTableCell align="center">{e.branchCode}</StyledTableCell>
...
export default (connect)(mapStateToProps,mapDispatchToProps)(PaymBranchTable)