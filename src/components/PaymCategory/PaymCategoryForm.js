import { Grid,Card,
  ...
  import {inputpaymCategoryForm} from './paymCategory';
  ...
  export default function Paymcategoryform() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Paym Category</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputpaymCategoryForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
