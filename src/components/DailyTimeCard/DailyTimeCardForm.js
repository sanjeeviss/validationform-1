...
import DailyTimeCardTables from './DailyTimeCardTables';
...
export default function DailyTimeCardForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Daily Time Card Entry</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
              inputDailyTimecardForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
