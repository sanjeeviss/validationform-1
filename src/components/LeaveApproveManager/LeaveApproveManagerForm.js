import { Grid,Card,
  ...
  import {inputLeaveAppManagerForm} from './LeaveApproveManager';
  ...
  export default function ApproveManagerForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Leave Approve Manager</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputLeaveAppManagerForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
