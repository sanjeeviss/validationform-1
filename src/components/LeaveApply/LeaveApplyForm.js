...
import { LEAVEAPPLY, PAYMEMPLOYEE, PAYMLEAVE } from '../../serverconfiguration/controllers';
...
const handleSubmit = async (e) => {
  ...
  console.log(formData)
    ...
    return (
      <div>
        ...
        <CardContent>
        <Typography variant='h5' color='S- Light' align='center'>Leave Apply</Typography>
        <form>
  ...
  <Grid  xs={12}  sm={6} item>
                ...
                name="yearend"
                  ...
                  {
                inputLeaveApplyForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
                  {/* <TextField {...input}  />  */}
                  </Grid>)
              }
  ...
  console.log(formData)
postRequest(ServerConfig.url,LEAVEAPPLY,formData).then((e)=>{
  console.log(e)
