import { Grid,Card,
  ...
  import {inputLoanEntryForm} from './LoanEntry';
  ...
  export default function LoanEntForm() {
    ...
    return (
      <div className="App">
        ...
        <CardContent>
        <Typography sx={{ mt: 3 }} align='center' color='primary' variant="h5">Loan Entry</Typography>
        <form>
          <Grid container spacing={2} columns={12} >
            {
            inputLoanEntryForm.map(input=> <Grid xs={input.xs} sm={input.sm} item>
